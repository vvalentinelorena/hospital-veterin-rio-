...
<script type="text/javascript">
    ...
    <body>
        ...
        <form action="excluirConsulta.jsp">
        Indique o número da sala e data-hora da Consulta que deseja excluir: 
        <p>
        ...
        <input type="submit" value="Pesquisar">
        	...
        	<p>
   			...
   			<p>
   			Data e Hora: <input name="txtDataHora" type="text" readonly value="<%= dataHora %>" class="dataHora" > 
   			</p>
	       	<p>
    		Procedimento: <input type="text" maxlength="200" name="txtProcedimento" size=60 readonly value= "<%= procedimento %>" />            
    		</p>
		    <br>
		    <hr>
