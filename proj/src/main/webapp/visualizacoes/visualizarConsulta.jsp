...
<body>
	...
	<form action="visualizarConsulta.jsp">
        Indique o número da sala e data-hora da Consulta que deseja visualizar: 
        <p>
        ...
        <input type="submit" value="Pesquisar">
        	...
        	<p>
   			...
   			<p>
   			Data e Hora: <input name="txtDataHora" type="text" readonly value="<%= dataHora %>" > 
   			</p>
	       	<p>
