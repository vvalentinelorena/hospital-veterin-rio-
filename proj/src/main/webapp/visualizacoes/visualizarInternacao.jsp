...
<head>
<meta charset="UTF-8">
<title>Visualizar - Internação</title>
<link href="../CSS/estilo3.css" rel="stylesheet" type="text/css">
</head>
<body>
	<h1>Visualizar Internação</h1>
	<hr><br>
	
		<form action="visualizarInternacao.jsp" method="get">
        <br><br><b>Indique o Id da Internação que deseja visualizar: </b>
        <p>
